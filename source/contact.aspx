<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="Crime_Management_System.contact" %>
...
<ul>
   ...
   <li class='active has-sub'><a href='register.aspx'><span class="icon-user-tie"> Register</span></a>
    ...
    <h4>Police Station Details</h4>
                <table id="tab1">
                    <tr>
                        <td>Bidhannagar Police Station</td>
                        <td>+9123876543</td>
                        <td>kolkatapolice@gmail.com</td>
                    </tr>

                    <tr>
                        <td>Lalbazar Station</td>
                        <td>033-298765</td>
                        <td>kolkatapolice@gmail.com</td>
                    </tr>
                    <tr>
